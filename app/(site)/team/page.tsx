...
export const metadata: Metadata = {
  title: 'Our Team | Lowcountry Guns & Range',
  description:
    'Meet the instructors and range safety officers at Lowcountry Guns & Range — Hardeeville’s premier indoor shooting facility serving Savannah, Hilton Head, and Beaufort.',
};
    ...
    <div className="flex flex-col">
      <section className="relative pt-32 pb-24 md:pt-48 md:pb-36 overflow-hidden bg-black">
        <div className="relative z-10 content-container animate-fade-up text-center max-w-4xl mx-auto drop-shadow-2xl">
          <p className="text-sm font-bold uppercase tracking-widest text-[var(--color-primary-base)] mb-4 animate-fade-up">
            Our people
          </p>
          <h1 className="text-4xl md:text-7xl lg:text-8xl font-black tracking-tight text-white mb-8 animate-fade-up text-balance">
            <span className="text-gradient-light brightness-125">Our Team</span>
          </h1>
          <p className="text-lg md:text-2xl text-zinc-100 leading-relaxed mx-auto max-w-2xl animate-fade-up font-medium text-balance">
            The South Carolina Lowcountry&apos;s premier indoor gun range, serving Hardeeville, Savannah, Hilton Head, and
            Beaufort with a safe, state-of-the-art environment for all.
          </p>
        </div>
      </section>
      ...
      <section className="section-spacing bg-gradient-section text-[var(--color-foreground)] pb-10 pt-16 md:pt-24 relative overflow-hidden scroll-mt-28">
        ...
        <div className="content-container relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold mb-6 tracking-tight text-[var(--color-foreground)] text-balance">
              Meet the Team
            </h2>
            <p className="text-lg md:text-xl text-[var(--color-muted-fg)] leading-relaxed font-medium text-balance">
              At Lowcountry Guns & Range, our staff is the heart of what we do. From maintaining a 0% tolerance safety policy
              to welcoming first-time shooters like family, our team of expert instructors and safety officers are here to
              ensure you have an incredible and safe experience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10 max-w-7xl mx-auto">
            {TEAM.map((member, i) => (
              <BentoCard
                key={member.name}
                className={`flex flex-col border-[var(--color-card-border)] pt-10 pb-10 px-6 bg-white shadow-sm text-center group hover:border-[var(--color-primary-base)] transition-all duration-500 rounded-3xl overflow-hidden relative ${i >= 3 ? 'lg:translate-x-[50%] lg:max-w-md lg:mx-auto' : ''}`}
              >
                ...
                <p className="text-xs font-black tracking-[0.2em] uppercase text-[var(--color-primary-base)] mb-5">
                  {member.title}
                </p>
                <p className="text-[var(--color-muted-fg)] text-sm leading-relaxed flex-grow font-medium">{member.bio}</p>
      ...
      <section className="section-spacing bg-white text-[var(--color-foreground)] pt-20 pb-24 relative overflow-hidden">
        ...
        <div className="content-container relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold mb-5 tracking-tight text-[var(--color-foreground)] text-balance">
            ...
            <p className="text-xl text-[var(--color-muted-fg)] max-w-2xl mx-auto font-medium leading-relaxed text-balance">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 max-w-6xl mx-auto">
            <BentoCard className="flex flex-col border border-[var(--color-card-border)] bg-gray-50/50 backdrop-blur-xl shadow-sm p-8 hover:border-[var(--color-primary-base)]/50 hover:-translate-y-1 transition-all duration-500 rounded-3xl relative">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <p className="text-[var(--color-muted-fg)] leading-relaxed text-lg italic flex-grow">
                  &quot;The staff here is amazing! They are so friendly and knowledgeable. I attended my first CWP class with
                  Chris and he was so patient and explained everything perfectly.&quot;
                </p>
            ...
            <BentoCard className="flex flex-col border border-[var(--color-card-border)] bg-gray-50/50 backdrop-blur-xl shadow-sm p-8 hover:border-[var(--color-primary-base)]/50 hover:-translate-y-1 transition-all duration-500 rounded-3xl relative">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <p className="text-[var(--color-muted-fg)] leading-relaxed text-lg italic flex-grow">
                  &quot;Excellent indoor facility with top-notch safety. The range officers are attentive and make sure everyone
                  feels secure. The modern automated targets were great!&quot;
                </p>
                <div className="mt-8 font-bold text-[var(--color-foreground)] flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-zinc-100 flex items-center justify-center text-zinc-400 font-bold overflow-hidden border border-[var(--color-card-border)]">
                    <User className="w-5 h-5" />
            ...
            <BentoCard className="flex flex-col border border-[var(--color-card-border)] bg-gray-50/50 backdrop-blur-xl shadow-sm p-8 hover:border-[var(--color-primary-base)]/50 hover:-translate-y-1 transition-all duration-500 rounded-3xl relative">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <p className="text-[var(--color-muted-fg)] leading-relaxed text-lg italic flex-grow">
                  &quot;Great selection of rentals and a very clean range. As a beginner, I was quite nervous, but the team here
                  made me feel right at home instantly.&quot;
                </p>
                <div className="mt-8 font-bold text-[var(--color-foreground)] flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-zinc-100 flex items-center justify-center text-zinc-400 font-bold overflow-hidden border border-[var(--color-card-border)]">
                    <User className="w-5 h-5" />
